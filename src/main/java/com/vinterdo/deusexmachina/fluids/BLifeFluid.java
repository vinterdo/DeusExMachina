...
public class BLifeFluid extends BlockFluidClassic
{
	...
	public BLifeFluid()
	{
		super(ModFluids.lifeFluid, Material.water);
		setCreativeTab(CreativeTabDEM.DEM_TAB);
		setBlockName("lifeFluid");
	}
	...
	{
		stillIcon = register.registerIcon(Reference.MOD_ID + ":lifeFluidStill");
	}
