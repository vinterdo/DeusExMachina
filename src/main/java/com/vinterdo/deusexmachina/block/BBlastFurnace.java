...
public class BBlastFurnace extends BTileEntityDEM
{
			...
			float hitY, float hitZ)
	{
		if (!world.isRemote)
		{
			...
			if (te.isFormed())
			{
				player.openGui(DeusExMachina.instance, GuiHandler.GuiIDs.BLAST_FURNACE.ordinal(), world,
	...
	{
		TEBlastFurnace teMe = (TEBlastFurnace) world.getTileEntity(x - ForgeDirection.getOrientation(side).offsetX,
