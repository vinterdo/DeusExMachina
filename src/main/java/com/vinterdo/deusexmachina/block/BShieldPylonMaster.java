...
public class BShieldPylonMaster extends BTileEntityDEM
{
	public BShieldPylonMaster()
	{
		super();
		this.setBlockName("ShieldPylonMaster");
	...
	{
		return new TEShieldPylonMaster();
	}
			...
			float hitY, float hitZ)
	{
		if (!world.isRemote)
		{
			TEShieldPylonMaster te = (TEShieldPylonMaster) world.getTileEntity(x, y, z);
			if (te.isFormed())
			{
