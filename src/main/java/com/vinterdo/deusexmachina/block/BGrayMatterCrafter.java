...
public class BGrayMatterCrafter extends BTileEntityDEM
{
	...
	{
		TEGrayMatterCrafterMaster te = (TEGrayMatterCrafterMaster) ((TEGrayMatterCrafter) world.getTileEntity(x, y, z))
				.getMaster();
		if (te != null)
	...
	{
		TEGrayMatterCrafter teMe = (TEGrayMatterCrafter) world.getTileEntity(
