...
public class BTeleportGateMaster extends BTileEntityDEM
{
	public BTeleportGateMaster()
	{
		super();
		this.setBlockName("teleportGateMaster");
	...
	{
		return new TETeleportGateMaster();
	}
			...
			float hitY, float hitZ)
	{
		if (!world.isRemote)
		{
			TETeleportGateMaster te = (TETeleportGateMaster) world.getTileEntity(x, y, z);
			if (te.isFormed())
				player.openGui(DeusExMachina.instance, GuiHandler.GuiIDs.TELEPORT_GATE.ordinal(), world, x, y,
						z);
