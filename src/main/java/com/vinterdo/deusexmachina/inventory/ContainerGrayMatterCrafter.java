...
public class ContainerGrayMatterCrafter extends ContainerDEM
{
	int lastProgress = -1;
	int lastPower = -1;
	...
	public ContainerGrayMatterCrafter(InventoryPlayer playerInv, TEDEM _te)
	{
		super(_te);
		te = (TEGrayMatterCrafterMaster) _te;
